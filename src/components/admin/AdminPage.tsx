            ...
            return (
              <>
                <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
                  {pageItems.map((p) => (
                    <div key={p.id} className="group relative border border-neutral-100 rounded-xl overflow-hidden hover:border-neutral-300 transition-colors">
                      ...
                      <div className="p-3">
                        <div className="text-[10px] font-mono font-bold text-blue-600 truncate">{p.brand}</div>
                        <div className="text-xs font-bold text-neutral-900 truncate mt-0.5">{p.name}</div>
                        <div className="text-xs text-neutral-500 mt-0.5">₩{p.price.toLocaleString()}</div>
                      </div>
                      <div className="absolute top-2 right-2 flex gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                        <button
                          onClick={() => handleEditClick(p)}
                          className="p-1.5 bg-white/95 text-neutral-600 hover:text-blue-600 rounded-lg shadow-sm cursor-pointer"
                          title="수정"
                        >
                        ...
                        <button
                          ...
                          className="p-1.5 bg-white/95 text-neutral-600 hover:text-red-500 rounded-lg shadow-sm cursor-pointer"
                          title="삭제"
                        >
                          <Trash2 className="w-3.5 h-3.5" />
                        </button>
